...
import { TraderOSDashboard } from '@/components/dashboard/TraderOSDashboard';
...
export default function DashboardPage() {
  ...
  // States
  const [activeView, setActiveView] = useState<'dashboard' | 'products' | 'downloads' | 'journal' | 'risk' | 'billing' | 'analytics' | 'insights' | 'community' | 'ai-review' | 'settings' | 'support'>('dashboard');
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activeView === 'dashboard' && (
                <TraderOSDashboard gamificationState={gamificationState} subscription={subscription} />
              )}
