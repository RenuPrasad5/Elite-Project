      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-zinc-800/80 pb-4">
        <div>
          ...
          <p className="text-xs text-zinc-500 font-mono">
            SYS_OVERWATCH // CRYPTO // BTC_ETH_ALT
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold font-mono tracking-widest text-zinc-300 uppercase">Terminal Chart: BTC/USD</h2>
          </div>
          <div className="w-full bg-[#0B0B0B] border border-zinc-800 p-1 rounded-sm shadow-xl h-[600px]">
            <TVAdvancedChart symbol="BINANCE:BTCUSD" />
          </div>
        </div>

        {/* Bottom: Crypto Screener */}
        <div className="flex flex-col gap-4 mt-4">
          <div className="flex items-center gap-2">
            <BarChart2 className="w-4 h-4 text-gold-500" />
            <h2 className="text-sm font-bold font-mono tracking-widest text-zinc-300 uppercase">Cryptocurrency Screener</h2>
          </div>
          <div className="w-full bg-[#0B0B0B] border border-zinc-800 p-1 rounded-sm shadow-xl h-[600px]">
